  ...
  return (
    <div className="w-full relative bg-nero flex flex-col items-center justify-start p-5 box-border gap-[20px] text-center text-16xl text-black1 font-segoe-ui sm:pl-[5px] sm:pr-[5px] sm:box-border">
      <Navbar
        ...
        quizzesColor="#000"
      />
      <div className="self-stretch rounded-mini bg-footer-header flex flex-row items-center justify-between py-0 px-[15px] z-[4] text-left text-29xl text-nero font-body-tiny-600 lg:flex-col md:flex-col sm:pl-[5px] sm:pr-[5px] sm:box-border">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[3] text-13xl font-inter">
        <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px]">
          ...
          <div className="self-stretch flex flex-row items-center justify-center p-2.5 text-xl text-dimgray font-body-tiny-600">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-[15px] gap-[15px] text-base font-body-tiny-600 md:flex-row md:flex-wrap">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[2]">
        ...
        <div className="self-stretch bg-nero flex flex-col items-start justify-start p-[15px] gap-[40px] text-13xl font-body-tiny-600">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[1]">
        ...
        <div className="self-stretch bg-nero flex flex-col items-start justify-start p-[15px] gap-[40px] text-13xl font-inter">
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-0 px-[70px] lg:flex-[unset] lg:self-stretch md:pl-2.5 md:pr-2.5 md:box-border md:flex-[unset] md:self-stretch">
              <div className="self-stretch flex flex-col items-start justify-start w-full">
                <div className="self-stretch flex flex-col items-start justify-start">
                  ...
                  <div className="self-stretch bg-nero flex flex-row items-center justify-center p-2.5 text-base font-body-tiny-600">
                    <div className="flex-1 relative leading-[22px] font-medium">
                      (April 2022)
                    </div>
                  </div>
                </div>
                <div className="self-stretch bg-nero flex flex-row items-center justify-center py-2.5 px-[30px] text-lg font-body-tiny-600">
          ...
          <div className="self-stretch bg-nero flex flex-row items-center justify-between text-9xl-7 font-body-tiny-600 lg:flex-col md:flex-col">
