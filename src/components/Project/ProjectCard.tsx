...
const ProjectCard: FunctionComponent<ProjectCardType> = ({
  ...
  return (
    <div className="w-[350px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-lg bg-nero flex flex-col items-start justify-start p-2.5 box-border relative gap-[25px] text-left text-5xl text-black1 font-body-tiny-600">
      <img
